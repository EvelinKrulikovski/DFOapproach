...
% we need a penalty term for the eigenvalues.
 ...
 f = - log(abs(x(11)))- log(abs(x(12))) - log(abs(x(13))) - log(abs(x(14)))...
     - log(abs(x(15))) - log(abs(x(16)))- log(abs(x(17)))- log(abs(x(18)))...
     - log(abs(x(19))) + 2*max(abs(v))*s;
% f = s;
