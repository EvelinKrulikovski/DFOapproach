function [fval,eigenvalue,exitflag,output,minNZ,bestever,sumNZ,s]=cma_es6

%
% Purpose: 
%         Runs CMA-ES for experiment 6 
%
% Output:
...
[x, fval, counteval, exitflag, output, bestever] = ...
    cmaes('funcinv6', initial_point,[],opts);
...
% x(1) to x(5) - a,b,c,d,e; x(6)=f, x(7)=h, x(8)=i; x(9)=j; x(10)=k;
% x(11)=g.
