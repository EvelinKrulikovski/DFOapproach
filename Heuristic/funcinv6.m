function [f] = funcinv6(x)
%
% Purpose:
%
%    Function funcinv6 is an user provided function which
...
s =norm(v-eig(A));
 ...
 f = -log(abs(x(1))) -log(abs(x(2))) -log(abs(x(3))) -log(abs(x(4)))...
     -log(abs(x(5))) -log(abs(x(6))) -log(abs(x(7))) -log(abs(x(8)))...
     -log(abs(x(9))) -log(abs(x(10))) -log(abs(x(11))) + 2*max(abs(v))*s;
